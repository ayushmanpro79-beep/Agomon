  ...
  return (
    <div className="bg-[#020617] border border-[#FFD60A]/10 rounded-xl p-3">
      <div className="flex flex-wrap gap-3 text-xs">
        ...
        {showRoute && <span className="flex items-center gap-1.5"><span className="w-6 h-1 bg-[#FF1A1A] inline-block border border-white" /> Route</span>}
        {showUser && <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-full bg-[#3B82F6] border-2 border-white inline-block" /> You</span>}
      </div>
