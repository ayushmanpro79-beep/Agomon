...
// src/app/pandal/[slug]/page.tsx:16 - dark cards, in-website dark map + Google Maps Start
      ...
      <FadeUp>
        <div className="bg-[#0B1220] rounded-2xl overflow-hidden border border-[#FFD60A]/10">
          ...
          <div className="p-4">
            ...
            {pandal.latitude && (
              <div className="mt-4">
                <p className="text-xs font-semibold text-[#FFD60A]/80 mb-2">View on Map (dark, in-website)</p>
                <PandalMap pandals={[pandal]} />
                <div className="mt-3 grid grid-cols-2 gap-2">
                  <Link href="/map" className="bg-[#0B1220] border border-[#FFD60A]/20 text-[#FFD60A] rounded-xl py-2.5 text-sm font-medium text-center hover:bg-[#FFD60A]/10 transition">View in App Map</Link>
                ...
                <p className="text-[11px] text-white/20 mt-2 text-center">Dark OSM inside app • Start opens Google Maps walking navigation</p>
              </div>
            )}
          </div>
        </div>
